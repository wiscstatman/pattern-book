...
pdf( file="feast5p1.pdf", height=6, width=6 )
labs <- c("A", "B", "C", "D", "E" )
...
plot( g.feastp1,  layout=ll, vertex.size=30, edge.arrow.size=.8, edge.arrow.width=.8,
                 edge.lty=1, edge.color="black", vertex.color="grey",
        edge.width=2, margin=c(0,.4,0,.4), vertex.label=labs, vertex.label.cex=2 )
...
pdf( file="feast5pIII.pdf", height=6, width=6 )
labs <- c("A", "B", "C", "D", "E" )
...
plot( g.feastpIII,  layout=ll, vertex.size=30, edge.arrow.size=.8, edge.arrow.width=.8,
                 edge.lty=1, edge.color="black", vertex.color="grey",
        edge.width=2, margin=c(0,.4,0,.4), vertex.label=labs, vertex.label.cex=2 )
...
pdf( file="triplyI.pdf", height=6, width=6 )
labs <- c("A", "B", "C", "D", "E" )
...
plot( g.triplyI,  layout=ll, vertex.size=30, edge.arrow.size=.8, edge.arrow.width=.8,
                 edge.lty=1, edge.color="black", vertex.color="grey",
        edge.width=2, margin=c(0,.4,0,.4), vertex.label=labs, vertex.label.cex=2 )
